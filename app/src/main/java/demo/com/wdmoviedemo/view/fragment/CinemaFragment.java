...
public class CinemaFragment extends BaseFragment {
    ...
    protected void initView(View view) {
        ...
        ObjectAnimator animator = ObjectAnimator.ofFloat(cineatRel, "translationX", 30f, 350f);
...
//            String locationDescribe = location.getLocationDescribe();    //获取位置描述信息
    ...
    void onccck(View view) {
        if (view.getId() == R.id.cinema_txt_ishit) {
            ...
            animatorf = false;
            //这是显示出现的动画
            ObjectAnimator animator = ObjectAnimator.ofFloat(cineatRel, "translationX", 510f, 30f);
            ...
            animatort = false;
            //这是隐藏进去的动画
            ObjectAnimator animator2 = ObjectAnimator.ofFloat(cineatRel, "translationX", 30f, 350f);
